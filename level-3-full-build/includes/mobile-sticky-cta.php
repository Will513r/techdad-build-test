<?php
/**
 * Sticky CTA bar visible only on mobile screens
 */
require_once __DIR__ . '/config.php';
?>
<div class="mobile-sticky-cta">
    <a href="tel:<?php echo PHONE_TEL; ?>" class="sticky-cta-btn sticky-cta-phone">
    ...
    <a href="<?php echo SITE_URL; ?>/contact" class="sticky-cta-btn sticky-cta-estimate">
        Get Free Estimate
    </a>
</div>
